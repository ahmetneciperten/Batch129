...
public class C01_StringManipulations {
    ...
    public static void main(String[] args) {
        System.out.printf("Yuz"+40+60);//Yuz4060 Concatenation
        System.out.printf("Yuz+(40+60)");//Yuz100
        System.out.printf("İki+40*6");//iki240
        System.out.printf(60+40+"Yuz");//100Yuz
